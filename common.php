<?php
    ...
    */
    ...
    //require_once realpath($path_base . ".." . DIRECTORY_SEPARATOR . ".." . DIRECTORY_SEPARATOR . "config.php");
    ...
    $client_side_libraries = array("gismo"          => array("gismo.js.php", "top_menu.js.php", "left_menu.js.php", "time_line.js", "gismo_util.js"),
                                   ...
                                   "third_parties"  => array("jquery/jquery-1.6.4.min.js",

                                                             "jquery-ui-1.8.16/js/jquery-ui-1.8.16.custom.min.js",

                                                             "jqplot.1.0.0b2.r1012/jquery.jqplot.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.barRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.canvasAxisLabelRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.canvasAxisTickRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.canvasTextRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.categoryAxisRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.dateAxisRenderer.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.highlighter.min.js",

                                                             "jqplot.1.0.0b2.r1012/plugins/jqplot.pointLabels.min.js",
    ...
    if (has_capability("block/gismo:track-user", $context_obj)) {

        $actor = "student";

    }

    if (has_capability("block/gismo:track-teacher", $context_obj)) {

...
$string['option_resource_sort_alpha'] = 'Resource sort order';
$string['option_resource_sort_alpha_yes'] = 'Alphabetical';
$string['option_resource_sort_alpha_no'] = 'Course order';

...
function gismo(config, srv_data, static_data, course_start_time, current_time, actor, completionenabled) { //Added completionenabled
    ...
    this.options = function () {
        ...
        var form = $('<form></form>')
                    ...
                    .append($('<fieldset></fieldset>')
                        ...
                        .append($('<input type="radio" name="include_hidden_items"></input>').attr({id: "include_hidden_items_yes", value: "1"}))
                        .append("<?php print_string('yes'); ?>")
                        .append($('<input type="radio" name="include_hidden_items"></input>').attr({id: "include_hidden_items_no", value: "0"}))
                        .append("<?php print_string('no'); ?>")
                        .append($('<br />'))
                        .append($('<label></label>').attr({"for": "resource_sort_alpha_yes"}).html("<?php print_string('option_resource_sort_alpha', 'block_gismo'); ?>"))
                        .append($('<input type="radio" name="resource_sort_alpha"></input>').attr({id: "resource_sort_alpha_yes", value: "1"}))
                        .append("<?php print_string('option_resource_sort_alpha_yes', 'block_gismo'); ?>")
                        .append($('<input type="radio" name="resource_sort_alpha"></input>').attr({id: "resource_sort_alpha_no", value: "0"}))
                        .append("<?php print_string('option_resource_sort_alpha_no', 'block_gismo'); ?>")
                        .append($('<br />'))
                    )
                    .append($('<fieldset></fieldset>')
                        .addClass("local_fieldset")
                        ...
                        .append($('<input type="radio" name="chart_base_color"></input>').attr({id: "charts_base_color_red", value: "1"}))
                        .append("<?php print_string('option_red', 'block_gismo'); ?>")
                        .append($('<input type="radio" name="chart_base_color"></input>').attr({id: "charts_base_color_green", value: "2"}))
                        .append("<?php print_string('option_green', 'block_gismo'); ?>")
                        .append($('<input type="radio" name="chart_base_color"></input>').attr({id: "charts_base_color_blue", value: "3"}))
                        .append("<?php print_string('option_blue', 'block_gismo'); ?>")
                        .append($('<br />'))
                        .append($('<label></label>'))
                        .append($('<input type="radio" name="chart_base_color"></input>').attr({id: "charts_base_color_g2r", value: "4"}))
        ...
        dialog.dialog({
            ...
            buttons: {
                ...
                '<?php print_string('save', 'block_gismo'); ?>': function() {
                    ...
                    g.cfg.resource_sort_alpha = parseInt($(this).find("input[name='resource_sort_alpha']:checked").val());
        ...
        $("#dialog #resource_sort_alpha_yes").prop('checked', (g.cfg.resource_sort_alpha == 1));
        $("#dialog #resource_sort_alpha_no").prop('checked', (g.cfg.resource_sort_alpha == 0));
    ...
    this.about = function () {
        ...
        var about = $('<div></div>')
                    .append($('<fieldset></fieldset>')
                        .addClass("local_fieldset")
                        .append($("<legend></legend>").html("LearnTrak"))
                        .append($("<p></p>").html("<?php print_string('intro_information_about_learntrak', 'block_gismo'); ?>"))
                        .append($("<p></p>").html("<?php print_string('learntrak_more_information', 'block_gismo'); ?>"))
                    )
                    .append($('<fieldset></fieldset>')
                        .addClass("local_fieldset")
                        ...
                        .append($("<p></p>").html("<?php print_string('gismo_more_information', 'block_gismo'); ?>"))
                    )
